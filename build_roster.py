...
for i, m in enumerate(members):
    ...
    avatar = './public/minsoc1.jpeg' if i % 2 == 0 else './public/minsoc2.jpeg'
...
# find <div class="roster__grid"> and replace until its closing </div>
pattern = re.compile(r'<div class="roster__grid">.*?      </div>', re.DOTALL)
new_content = re.sub(pattern, new_grid, content)

# update cache buster
new_content = new_content.replace('href="./styles.css?v=4"', 'href="./styles.css?v=5"')
new_content = new_content.replace('href="./styles.css?v=3"', 'href="./styles.css?v=5"')
new_content = new_content.replace('href="./styles.css"', 'href="./styles.css?v=5"')

with open(html_file, 'w', encoding='utf-8') as f:
    f.write(new_content)

print("Updated index.html safely with exactly 14 members using minsoc photos.")
